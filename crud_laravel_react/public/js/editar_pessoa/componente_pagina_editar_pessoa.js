class ComponentePaginaEditarPessoa extends React.Component{
  chave_do_react;
  ...
  html_para_react(elemento){
    ...
    array_atributos["key"] = "ComponentePaginaEditarPessoa tag " + this.chave_do_react; //React precisa disso.
    this.chave_do_react++;
    ...
    if(typeof array_atributos["id"] !== "undefined"){
      switch(array_atributos["id"]){
        case "div_editar_nome":
          elemento = React.createElement(ComponenteEditarNome, {key: "ComponenteEditarNome", elemento: elemento}, null);
          return elemento;
        break;
        case "div_editar_sobrenome":
          elemento = React.createElement(ComponenteEditarSobrenome, {key: "ComponenteEditarSobrenome", elemento: elemento}, null);
          return elemento;
        break;
        case "div_editar_cpf":
          elemento = React.createElement(ComponenteEditarCPF, {key: "ComponenteEditarCPF", elemento: elemento}, null);
          return elemento;
        break;
        case "div_editar_data_de_nascimento":
          elemento = React.createElement(ComponenteEditarDataDeNascimento, {key: "ComponenteEditarDataDeNascimento", elemento: elemento}, null);
          return elemento;
        break;
        case "div_editar_sexo":
          elemento = React.createElement(ComponenteEditarSexo, {key: "ComponenteEditarSexo", elemento: elemento}, null);
          return elemento;
        break;
        case "div_editar_setor":
          elemento = React.createElement(ComponenteEditarSetor, {key: "ComponenteEditarSetor", elemento: elemento}, null);
          return elemento;
        break;
        case "div_editar_email":
          elemento = React.createElement(ComponenteEditarEmail, {key: "ComponenteEditarEmail", elemento: elemento}, null);
          return elemento;
        break;
        case "div_editar_telefone_fixo":
          elemento = React.createElement(ComponenteEditarTelefoneFixo, {key: "ComponenteEditarTelefoneFixo", elemento: elemento}, null);
          return elemento;
        break;
        case "div_editar_telefone_movel":
          elemento = React.createElement(ComponenteEditarTelefoneMovel, {key: "ComponenteEditarTelefoneMovel", elemento: elemento}, null);
          return elemento;
        break;
        case "div_editar_telefone_estrangeiro":
          elemento = React.createElement(ComponenteEditarTelefoneEstrangeiro, {key: "ComponenteEditarTelefoneEstrangeiro", elemento: elemento}, null);
          return elemento;
        break;
        case "botao_editar":
...
class ComponenteEditarSetor extends React.Component{
  ...
  componentDidMount(){
    if(typeof window.evento_do_editar_setor_ja_foi_adicionado === "undefined"){
      window.evento_do_editar_setor_ja_foi_adicionado = true; //Necessário caso esteja usando React.StrictMode
...
const div_pagina_editar_pessoa = document.getElementById("div_pagina_editar_pessoa");
const div_componente_pagina_editar_pessoa = document.getElementById("div_componente_pagina_editar_pessoa");

const root = ReactDOM.createRoot(div_componente_pagina_editar_pessoa);
root.render(
  React.createElement(
    React.StrictMode, 
    null,
    React.createElement(ComponentePaginaEditarPessoa, {elemento: div_pagina_editar_pessoa}, null)
  )
);
